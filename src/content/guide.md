...
- Un **menu déroulant** permet de choisir le texte à résumer parmi ceux rattachés au dossier (un dossier peut contenir plusieurs versions du texte). Pour les lois promulguées, une entrée **« Version consolidée »** apparaît en fin de liste : il s'agit de la version actuellement en vigueur, qui intègre toutes les modifications votées depuis la publication initiale. Un lien permet de la consulter directement sur Légifrance.
