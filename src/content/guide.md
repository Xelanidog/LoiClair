...
- Une **timeline verticale** retrace le parcours législatif du dossier étape par étape (Dépôt → Assemblée nationale → Sénat → CMP → Conseil constitutionnel → Promulguée…), avec la **date** de chaque étape et la **durée en jours** entre deux étapes consécutives. L'étape en cours est signalée par un point animé. Les étapes non encore atteintes apparaissent en pointillés. Après la promulgation, la timeline peut afficher les **décrets d'application** et le statut d'**application** de la loi. Pour les textes qui ne sont pas des lois (résolutions, rapports…), l'étape « Promulguée » n'apparaît pas.
- Des **indicateurs de chronologie** résument le déroulement du dossier : la **durée totale** depuis le dépôt (affichée en vert avec la mention « Promulgué en X jours » si la loi est adoptée, ou en jaune avec « En cours depuis X jours » si le texte est encore en examen), le **temps passé à l'Assemblée nationale** et au **Sénat** (du dépôt à la décision dans chaque chambre), la tenue d'une **Commission mixte paritaire** si applicable, et le **nombre de scrutins** organisés. Ces indicateurs n'apparaissent que lorsque la donnée est disponible — un dossier traité uniquement à l'AN n'aura pas d'indicateur Sénat, et un texte non encore voté n'aura pas de compteur de scrutins.
- Un **menu déroulant** permet de choisir le texte à résumer parmi ceux rattachés au dossier (un dossier peut contenir plusieurs versions du texte). Les textes sont **triés par ordre chronologique**. Pour les lois promulguées, le menu inclut aussi les **décrets d'application** (identifiés par leur numéro, par exemple « Décret n° 2025-877 ») : ce sont les textes pris par le Gouvernement pour rendre la loi applicable dans la pratique. Vous pouvez demander un résumé IA de chaque décret exactement comme pour le texte de loi. Une entrée **« Version consolidée »** apparaît en fin de liste : il s'agit de la version actuellement en vigueur, qui intègre toutes les modifications votées depuis la publication initiale, datée de sa dernière mise à jour. Un lien permet de la consulter directement sur Légifrance.
