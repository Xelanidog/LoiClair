...
- Une **timeline verticale** retrace le parcours législatif du dossier étape par étape (Dépôt → Assemblée nationale → Sénat → CMP → Conseil constitutionnel → Promulguée…), avec la **date** de chaque étape et la **durée en jours** affichée sur la ligne de connexion entre deux étapes. L'étape en cours est signalée par un point animé. Les étapes non encore atteintes apparaissent en pointillés. L'étape **Promulguée** porte une icône ✓ et affiche directement en vert la **durée totale** du parcours (« Promulgué en X j »). Après la promulgation, la timeline affiche les **décrets d'application** (avec la durée de publication de l'ensemble des décrets) et le statut d'**application** de la loi (avec une icône drapeau et la mention « Appliquée en X j »). Quand une loi est d'**application directe** (elle ne nécessite pas de décret), l'étape finale indique « Promulguée (application directe) » avec « Promulgué et appliqué en X j ». Pour les textes qui ne sont pas des lois (résolutions, rapports…), l'étape « Promulguée » n'apparaît pas. L'étape en cours affiche la mention « en cours depuis X j » en orange pour visualiser le temps écoulé.
