...
- Une **timeline verticale** retrace le parcours législatif du dossier étape par étape (Dépôt → Assemblée nationale → Sénat → CMP → Conseil constitutionnel → Promulguée…), avec la **date** de chaque étape et la **durée en jours** affichée sur la ligne de connexion entre deux étapes. L'étape en cours est signalée par un point animé. Les étapes non encore atteintes apparaissent en pointillés. Après la promulgation, la timeline affiche les **décrets d'application** (avec la durée de publication de l'ensemble des décrets) et le statut d'**application** de la loi. Pour les textes qui ne sont pas des lois (résolutions, rapports…), l'étape « Promulguée » n'apparaît pas.
- Un **indicateur de durée totale** résume le déroulement du dossier : affiché en vert avec la mention « Promulgué en X jours » si la loi est adoptée, ou en jaune avec « En cours depuis X jours » si le texte est encore en examen. Dans la timeline, l'étape en cours affiche également la mention « en cours depuis X j » en orange pour visualiser le temps écoulé à cette étape.
