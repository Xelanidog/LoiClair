...
- Un **sélecteur de texte** permet de choisir quel texte résumer. Les textes sont regroupés par étape législative (Assemblée nationale, Sénat, CMP, Promulguée…) et **triés par date** au sein de chaque étape. Par défaut, la loi promulguée est sélectionnée si elle existe, sinon le dernier texte adopté. Un lien **« Lire le texte »** permet d'ouvrir directement le texte officiel sur Légifrance. Pour les lois promulguées, le menu inclut aussi les **décrets d'application** et la **version consolidée**.
- Le **résumé IA**, signalé par une icône ✨ et le label « Résumé IA », est structuré en **4 sections** : un paragraphe *En bref* (2-3 phrases de synthèse visible immédiatement), puis *Pourquoi cette loi ?*, *Changements clés*, et *Impact attendu*. Sur mobile, les 3 dernières sections sont présentées en accordéon (une seule ouverte à la fois) ; sur ordinateur, elles s'affichent côte à côte en grille.
- Si le texte sélectionné n'est pas encore publié, un message l'indique clairement et vous pouvez sélectionner un autre texte via le sélecteur.
